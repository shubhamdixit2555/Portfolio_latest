        ...
        <div className="flex flex-col md:flex-row justify-between w-full gap-3 px-3 md:px-16 py-3">
          ...
          <div className="md:w-[50%] flex flex-col items-start gap-6 md:gap-7 max-w-md">
            <form className="max-w-md w-full px-3 py-2" action="https://api.web3forms.com/submit" method="POST">
              ...
              <button type="submit" className="cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-3">Submit</button>
            </form>
          </div>
        </div>
